...
import { Fanatique } from "../../typechain-types";
...
//0x8A327e6BD5Fb88C1B94A3eC186B4Ec4985e8286f
export async function deployFanatiqueCards() {

  console.log(`Deploying Fanatique...`);

  const contracts = ["Fanatique.sol:Fanatique"]
  const args = [env.TREASURY_ADDRESS] as const;

...
task("deploy", "Deploy contracts")
  ...
  .setAction(async (taskArgs, env) => {
    ...
    const { deployFanatique,deployFanToken,deployERC20,deployFanatiqueCards } = await import("./deploy/deploy");
    ...
    contractDeploy.set("fanatique-cards", deployFanatiqueCards);
